...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.toolBarGeneral)
        ...
        self.formLayout.setWidget(
            2, QFormLayout.ItemRole.FieldRole, self.check_box_auto_apply_filter
        )
